...
const CompleteDashboard = () => {
  ...
  const fetchAllData = async () => {
    try {
      ...
      const purchasesRes = await axios.get('https://cold-storage-system.onrender.com/api/purchases/all?limit=1000');
      const purchases = purchasesRes.data.purchases || [];

      // Fetch sales data
      const salesRes = await axios.get('https://cold-storage-system.onrender.com/api/sales/all?limit=1000');
      const sales = salesRes.data.sales || [];

      // Fetch customers data
      const customersRes = await axios.get('https://cold-storage-system.onrender.com/api/customers/all?limit=1000');
    ...
    return (
      <Layout>
        <div className="flex justify-center items-center h-64">
          ...
          <span className="ml-4 text-xl font-semibold text-blue-600">Loading Dashboard...</span>
        </div>
      </Layout>
    );
  }
      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 p-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-8 text-center">
            ...
            <p className="text-gray-600 text-lg">Complete automation and management dashboard</p>
            ...
            <div className="bg-white rounded-2xl shadow-xl p-6 border border-green-100 hover:shadow-2xl transition-shadow">
              <div className="flex items-center justify-between mb-4">
                <div>
                  ...
                  <p className="text-3xl font-bold text-green-600">{dashboardData.farmers.total}</p>
                </div>
            ...
            <div className="bg-white rounded-2xl shadow-xl p-6 border border-blue-100 hover:shadow-2xl transition-shadow">
              <div className="flex items-center justify-between mb-4">
                <div>
                  ...
                  <p className="text-3xl font-bold text-blue-600">{dashboardData.purchases.total}</p>
                  <p className="text-sm text-gray-500">₹{dashboardData.purchases.amount.toFixed(2)}</p>
                </div>
            ...
            <div className="bg-white rounded-2xl shadow-xl p-6 border border-purple-100 hover:shadow-2xl transition-shadow">
              <div className="flex items-center justify-between mb-4">
                <div>
                  ...
                  <p className="text-3xl font-bold text-purple-600">{dashboardData.sales.total}</p>
                  <p className="text-sm text-gray-500">₹{dashboardData.sales.amount.toFixed(2)}</p>
                </div>
            ...
            <div className="bg-white rounded-2xl shadow-xl p-6 border border-orange-100 hover:shadow-2xl transition-shadow">
              <div className="flex items-center justify-between mb-4">
                <div>
                  ...
                  <p className="text-3xl font-bold text-orange-600">{dashboardData.customers.total}</p>
                </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            ...
            <div className="bg-white rounded-2xl shadow-xl p-6 border border-indigo-100">
              <h3 className="text-xl font-bold text-indigo-800 mb-4">🏬 Storage Status</h3>
              <div className="space-y-3">
                <div className="flex justify-between items-center">
                  <span className="text-gray-600">Total Items Stored</span>
                  <span className="font-bold text-indigo-600">{dashboardData.storage.total}</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-gray-600">Capacity Used</span>
                  <span className="font-bold text-indigo-600">{dashboardData.storage.capacity}%</span>
                </div>
            ...
            <div className="bg-white rounded-2xl shadow-xl p-6 border border-yellow-100">
              <h3 className="text-xl font-bold text-yellow-800 mb-4">📦 Inventory Status</h3>
              <div className="space-y-3">
                <div className="flex justify-between items-center">
                  <span className="text-gray-600">Total Items</span>
                  <span className="font-bold text-yellow-600">{dashboardData.inventory.items}</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-gray-600">Low Stock Items</span>
                  <span className="font-bold text-red-600">{dashboardData.inventory.lowStock}</span>
                </div>
            ...
            <div className="bg-white rounded-2xl shadow-xl p-6 border border-green-100">
              <h3 className="text-xl font-bold text-green-800 mb-4">📈 Profit Summary</h3>
              <div className="space-y-3">
                <div className="flex justify-between items-center">
                ...
                <div className="border-t pt-2 flex justify-between items-center">
                  ...
                  <span className="font-bold text-green-600">
                    ₹{(dashboardData.sales.amount - dashboardData.purchases.amount).toFixed(2)}
                  </span>
                </div>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="bg-white rounded-2xl shadow-xl p-6 border border-gray-100">
              <h3 className="text-xl font-bold text-gray-800 mb-4">🛍️ Recent Purchases</h3>
                  ...
                  {dashboardData.purchases.recent.map((purchase, index) => (
                    <div key={index} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                      ...
                      <div className="text-right">
                        ...
                        <div className="text-sm text-gray-500">{purchase.bags} bags</div>
                      </div>
                    </div>
                  ))}
                </div>
                  ...
                  {dashboardData.sales.recent.map((sale, index) => (
                    <div key={index} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                      ...
                      <div className="text-right">
                        ...
                        <div className="text-sm text-gray-500">{sale.quantity} kg</div>
                      </div>
                    </div>
                  ))}
                </div>
