...
const InvoicePage = () => {
  ...
  useEffect(() => {
    const fetchInvoice = async () => {
      try {
        const res = await axios.get(`${API_ENDPOINTS.PURCHASES}/${id}`);
  ...
  const downloadPDF = async () => {
    ...
    if (!input) {
      MySwal.fire(
        "Error",
        "Invoice content not found for PDF generation.",
        "error"
      );
      return;
    }
    ...
    try {
      ...
      pdf.save(
        `Purchase-Invoice-${purchase.lotNo || id.slice(-6).toUpperCase()}.pdf`
      );
          ...
          <div className="flex flex-col lg:flex-row justify-between items-start border-b-4 border-sky-600 pb-6 mb-8">
            <div className="mb-4 lg:mb-0">
              ...
              <p className="text-gray-600 font-medium">
                Cold Storage & Aloo Supply Experts
              </p>
            ...
            <div className="bg-sky-50 p-4 rounded-xl border border-sky-200">
              <div className="text-right">
                ...
                <p className="text-xl font-bold text-sky-700">
                  INV-{lotNo || id.slice(-6).toUpperCase()}
                </p>
              ...
              <div className="bg-purple-50 p-6 rounded-xl border border-purple-200">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-semibold">
                      {weightPerBag ? `${weightPerBag} kg` : "N/A"}
                    </span>
                  </div>
                </div>
              </div>
              ...
              <table className="w-full">
                ...
                <tbody>
                  <tr className="border-b border-gray-200 bg-white">
                    ...
                    <td className="p-4 font-medium text-sky-600">
                      {variety || "N/A"}
                    </td>
          ...
          <div className="border-t-2 border-gray-200 pt-6">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              <div>
                ...
                <p className="text-sm text-gray-500">
                  This invoice is computer-generated and doesn't require a
                  signature.
                </p>
              </div>
              <div className="text-right">
